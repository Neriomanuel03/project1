...
<li class="nav-item">
   ...
   <hr class="sidebar-divider d-none d-md-block">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="convidado.php">
   ...
   <hr class="sidebar-divider d-none d-md-block">
            ...
            <!-- Sidebar Message -->
            <div class="sidebar-card d-none d-lg-">
...
<path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
  ...
  <div class="card">
  <a href="upload/648aad7dd95d2.pdf"><img src="IMG/Um segredo para contar.png" class="card-img-top" alt="..."></a>
                <div class="card-body">
                <h5 class="card-title"> UM SEGREDO PRA CONTAR </h5>
                <p class="card-text"> Esta é a Lucimar. Ela e suas amigas têm um segredo Do fundo do mar. </p>
                </div>
                <div class="card-footer">
                <a href="upload/648aad7dd95d2.pdf" class="btn btn-primary">Ler livro</a>
                </div>
  </div>
</div>
