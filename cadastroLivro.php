    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card">
                  <div class="card-body">
                   <h4 class="card-title"><b>Cadastrar Livro</b></h4> 
                    
                    <form class="forms-sample" method="post" enctype="multipart/form-data" action="guardarlivro.php">
                      <div class="form-group">
                        <label for="exampleInputName1">Titulo</label>
                        <input type="text" name= "titulo" class="form-control" id="exampleInputName1" placeholder="Titulo do livro" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Autor</label>
                        <input type="text" name= "autor" class="form-control" id="exampleInputEmail3" placeholder="Digite o nome do autor" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Editora</label>
                        <input type="text" name= "editora" class="form-control" id="exampleInputPassword4" placeholder="nome da Editora" >
                      </div>

                       <div class="form-group">
                        <label for="exampleInputPassword4">Data de Cadastro</label>
                        <input type="date" name= "data1" class="form-control" id="exampleInputPassword4" placeholder="Data1" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleSelectGender">Volume</label>
                        <select class="form-control" name= "volume" id="exampleSelectGender">
