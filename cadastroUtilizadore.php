...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="cadatraUZ.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="genero" id="exampleSelectGender">
                          ...
                          <option value="Femenino">Outro</option>
                        </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="cidade" class="form-control" id="exampleInputCity1" placeholder="Digite a morada">
                      </div>
    ...
    <script src="https://kit.fontawesome.com/870b66b957.js" crossorigin="anonymous"></script>
</body>
